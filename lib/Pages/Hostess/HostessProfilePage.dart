...
import 'package:mobile_dev/Pages/Hostess/ChangehostesPhone.dart';
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${hostessController.hostess_.name} ${hostessController.hostess_.surname}', // Kullanıcı adınızı dinamik olarak değiştirebilirsiniz
                    style: TextStyle(
                      fontSize: 24.0,
